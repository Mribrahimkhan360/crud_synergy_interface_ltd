...
<head>
    ...
    <!-- Optional: Google Font (Inter is very clean & modern) -->
...
<!-- Form -->
    ...
    <div class="text-center text-sm">
        ...
        <a href="{{ url('/register') }}" class="font-medium text-primary hover:text-primarydark hover:underline transition duration-150">
            Create one now
        </a>
    </div>
